...
export default function AdminDashboard() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setRequests((requestsData.records || []) as RequestData[]);
      ...
      <div className="flex-1 p-4 md:p-8">
        ...
        <div className="max-w-7xl mx-auto space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <Card className="p-6 bg-gradient-to-br from-purple-50 to-purple-50 border-purple-200">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Total product records</p>
                  </div>
                </Card>
                ...
                <Card className="p-6 bg-gradient-to-br from-amber-50 to-amber-50 border-amber-200">
                  <div className="space-y-2">
                    ...
                    <p className="text-3xl font-bold text-amber-700">{globalStats.soldTickets}</p>
                    <p className="text-xs text-gray-500">Successfully sold products</p>
                  </div>
                </Card>
                ...
                <Card className="p-6 bg-gradient-to-br from-emerald-50 to-emerald-50 border-emerald-200">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Total value of all records</p>
                  </div>
                </Card>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card className="p-6 bg-gradient-to-br from-yellow-50 to-yellow-50 border-yellow-200">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Awaiting QC start</p>
                  </div>
                </Card>
                ...
                <Card className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 border-cyan-200">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Currently in movement</p>
                  </div>
                </Card>
                ...
                <Card className="p-6 bg-gradient-to-br from-red-50 to-orange-50 border-red-200">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-medium text-gray-600">Damaged / On Hold</p>
                      <Activity className="w-5 h-5 text-red-600" />
                    </div>
                    <p className="text-3xl font-bold text-red-700">{globalStats.onHoldTickets}</p>
                    <p className="text-xs text-gray-500">Processing paused</p>
                  </div>
                </Card>
              </div>
            </>
          ...
          <Tabs defaultValue="requests" className="w-full">
            <TabsList>
              <TabsTrigger value="requests">All Records</TabsTrigger>
              ...
              <Card className="p-6">
                <div className="mb-4 space-y-4">
                  <div className="flex gap-2 flex-wrap">
                    <Input
                      placeholder="Search by product ID, name, batch..."
                      value={searchQuery}
                  ...
                  <>
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow className="bg-muted/50">
                            ...
                            <TableHead className="text-xs font-semibold">Batch / SKU</TableHead>
                            <TableHead className="text-xs font-semibold">Status</TableHead>
                            <TableHead className="text-xs font-semibold">Value</TableHead>
                            <TableHead className="text-xs font-semibold">Verified By</TableHead>
                          ...
                          {requests.length === 0 ? (
                            ...
                            requests.map((req: RequestData) => (
                              ...
                              >
                                ...
                                <TableCell className="text-sm">{req.batch_sku}</TableCell>
                                <TableCell>
                                  <Badge className={getStatusColor(req.status)}>{req.status}</Badge>
                                </TableCell>
                                <TableCell className="text-sm font-semibold">₦{req.total_value?.toLocaleString() || '0.00'}</TableCell>
                                <TableCell className="text-sm text-muted-foreground">{req.recorder_name}</TableCell>
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <p className="text-sm text-muted-foreground">
                        Showing {requests.length} of {totalRequests} records
                      </p>
                      <div className="flex gap-2">
                        <Button
