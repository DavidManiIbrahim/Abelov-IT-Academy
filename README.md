...
A comprehensive record management system for tracking product entries, verifications, and distribution with **full CRUD functionality**, **secure REST API**, and a **Node.js + Express + MongoDB backend**.
