...
const EnvSchema = z.object({
  ...
  RATE_LIMIT_MAX: z
    ...
    .transform((v) => Number(v))
    .default("100"),
  MONGODB_URI: z.string().min(1).default("mongodb://itzlimincj_db_user:0vuy1Ij7g1dLlg8s@ac-bw9lspx-shard-00-00.xf141ou.mongodb.net:27017,ac-bw9lspx-shard-00-01.xf141ou.mongodb.net:27017,ac-bw9lspx-shard-00-02.xf141ou.mongodb.net:27017/armsdb?authSource=admin&replicaSet=atlas-frgno8-shard-0&ssl=true"),
